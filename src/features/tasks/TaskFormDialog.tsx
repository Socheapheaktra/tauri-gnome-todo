            ...
            <div className="space-y-4 px-4 py-4">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="mt-1 min-h-44 rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 dark:border-zinc-800 dark:bg-zinc-950">
                    {description.trim() ? (
              ...
              {activeProjects.length === 0 ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-md border border-zinc-200 bg-white p-3 text-sm dark:border-zinc-800 dark:bg-zinc-900">
                    ...
                    {description.trim() ? (
                      <TaskDescription className="mt-2" markdown={description} variant="compact" />
                    ) : null}
